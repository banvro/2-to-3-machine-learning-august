...
from myauth.models import ContactModel
...
def contactus(request):
    if request.method == "POST":
        ...
        if name != "" and emial != "" and pnumber != "" and msg != "":
            data = ContactModel(name = name, email = emial, phonenumber = pnumber, message = msg)
            data.save()

            mail = EmailMessage("Sending EMail From Django", msg, "banvro07@gmail.com", ["banvro07@gmail.com", "ravinderghintala340@gmai.com", "rriishhii@gmail.com"])
            mail.send()

            messages.success(request, "Your Data Saveed Sccessfully..")
        else:
            messages.warning(request, "Please Enter Data in Fields.")
